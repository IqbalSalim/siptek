        ...
        <div class="relative overflow-x-auto border shadow-md sm:rounded-lg dark:border-gray-700">
            ...
            <div
                ...
                <div x-show='rekapan' class="block text-right">
                    <form action="{{ route('cetak-laporan') }}" method="POST" target="_blank" novalidate>
                        @csrf
            ...
            <div x-show='rekapan' class="overflow-x-auto">
                @if (count($rekapan) > 0)
                <table class="w-full text-sm text-left text-gray-500 table-auto border-slate-500 dark:text-gray-400">
