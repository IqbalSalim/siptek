        ...
        <div class="relative w-full h-full max-w-xl p-4 mx-auto md:h-auto">
            ...
            <div
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Edit Presensi DL</h3>
                    <p class="font-bold">{{ $date ? $date->isoFormat('dddd, D MMMM Y') : '' }}</p>
                    <p class="text-sm"><span class="font-bold">Feedback:</span> {{ $feedback }}</p>
                    <form class="space-y-6" wire:submit.prevent="update" novalidate>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <div>
                                    <embed class="w-full" src="{{ $file ? $file->temporaryUrl() : $filePreview }}"
