<div x-cloak x-data="{ modalWfo: false, modalDl: false, modalEditDl: false }" x-on:close-modal-wfo="modalWfo=false" x-on:close-modal-dl="modalDl=false"
    x-on:close-modal-editdl="modalEditDl=false">
    <x-slot name="header">
