    ...
    <div x-show="modalDl"
        ...
        <div class="relative w-full h-full max-w-2xl p-4 mx-auto md:h-auto">
            ...
            <div
                ...
                <button id="btn-close-modalDl" type="button" wire:click='closeForm'
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <div>
                        ...
                        <input type="file" id="myFile" wire:change.debounce.2000ms='setMap' wire:model.defer='file'>
                    ...
                    <button type="button" wire:click.debounce.500ms='save' id="btn-submit-dlpre"
                        class="w-full mt-2 btn-primary">Simpan</button>
                </div>
            </div>
        </div>
    </div>
